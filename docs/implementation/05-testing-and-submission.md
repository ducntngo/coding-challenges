...
Active draft. The early automated headless integration harness now exists, covers accepted answer flow plus session-wide score and leaderboard fanout, and now also covers closed-phase answer rejection. It should deepen further as scoring and current-question-aware answer validation become real.
...
6. Add assertions for duplicate, late, and wrong-question rejection once explicit current-question context exists.
