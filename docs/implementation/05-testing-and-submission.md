...
Active draft. The early automated headless integration harness now exists, covers accepted answer flow plus session-wide score and leaderboard fanout, and now also covers closed-phase and wrong-question rejection. It should deepen further as scoring and real question progression become real.
...
6. Add assertions for duplicate and late-answer rejection once real question progression exists.
